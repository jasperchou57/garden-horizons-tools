  ...
  'mainEntity': [
    {
      ...
      'acceptedAnswer': {
        '@type': 'Answer',
        'text': 'Some mutations are stackable (like weather effects) while others are exclusive (like Lush). In our calculator, you can select multiple stackable mutations to see combined ROI.'
      }
    },
    {
      '@type': 'Question',
      ...
      'acceptedAnswer': {
        '@type': 'Answer',
        'text': 'Lush stage gives 1.5x value multiplier. However, if you\'re about to go offline, it\'s better to harvest at ripened (1x) than risk losing the plant entirely.'
      }
    },
    {
      '@type': 'Question',
      ...
      'acceptedAnswer': {
        '@type': 'Answer',
        'text': 'No, the Lush mutation only triggers when you stay online during the entire growth period. This is why our calculator shows "Assume Lush" as an optional strategy.'
      }
    },
    {
      '@type': 'Question',
      ...
      'acceptedAnswer': {
        '@type': 'Answer',
        'text': 'It depends on your goal! Use our Smart Planting Planner to enter your budget and playtime, then choose between maximizing ROI, profit per hour, or total profit.'
      }
    }
  ]
};
